...
# fit_student<-stan(file=here("output_selected_model","prior_checks","models_prior_checks","prior_check_all_int_uninform_beta_10.stan"),
#                  data=data.list,
#                  #init=inits,
...
sigma_q_l<-(post_student$sigma_q_l)
...
log_q_l<-as.data.frame(post_student$log_q_l)
...
# ggsave(here("output_selected_model","prior_checks","prior_checks_student","beta.sigma.posterior.student.10.png"), height=8, width=6)
# 

```
```{r}
# icc.df<-data.frame(group=c(rep("Angler effect", 8000), rep("Date effect", 8000), rep("Lake effect", 8000)),
#                      ICC=c(post_student$ICC_a, post_student$ICC_d, post_student$ICC_l))
# 
# ggplot(icc.df)+
...
# ggsave(here::here("output_selected_model","prior_checks","prior_checks_student","ICC_density_student_10.png"), height=4, width=6)
...
```{r}
popDensity.prior<-post_student$prior_t_popDensity[post_student$prior_t_popDensity>=0]
half.t.prior<-post_student$prior_t_other[post_student$prior_t_other>=0]
phi.prior<-post_student$prior_phi
prior.sigma<-post_student$prior_sigma
...
```{r}
sigma.check<-data.frame(group=c(rep("prior", 4033), rep("angler", 8000), rep("date", 8000), rep("lake", 8000)),
...
```{r}
set.seed(482)
# fit_student_1<-stan(file=here("output_selected_model","prior_checks","models_prior_checks","prior_check_all_int_uninform_beta_1.stan"),
#                  data=data.list,
#                  #init=inits,
#                  control=list(stepsize=0.1, max_treedepth=15),
#                  chains=4,
...
sigma_q_l<-(post_student_1$sigma_q_l)
...
log_q_l<-as.data.frame(post_student_1$log_q_l)
...
plot_grid(sigma.random.plot, sigma.fixed.plot, sigma.e.plot, sigma.total.plot, ncol=1, align="v")
#plot_grid(sigma.total.plot, sigma.e.plot, sigma.fixed.plot, sigma.random.plot, ncol=1, align="v")
ggsave(here("output_selected_model","prior_checks","prior_checks_student","beta.sigma.posterior.student.1.png"), height=8, width=6)

r2.df<-data.frame(type=c(rep("marginal", 8000), rep("conditional", 8000)),
                  r2=c(post_student_1$r2_marginal, post_student_1$r2_conditional))
...
ggplot(r2.df)+
  ...
  theme_bw()+
    theme(legend.text=element_text(size=10),
        axis.title.y=element_text(size=12),
        axis.title.x=element_text(size=12))
ggsave(here::here("output_selected_model","prior_checks","prior_checks_student","R2_density_student_1.png"), height=4, width=6)


```
```{r}
icc.df<-data.frame(group=c(rep("Angler effect", 8000), rep("Date effect", 8000), rep("Lake effect", 8000)),
                     ICC=c(post_student_1$ICC_a, post_student_1$ICC_d, post_student_1$ICC_l))
...
ggplot(icc.df)+
  ...
  theme_bw()+
    theme(legend.text=element_text(size=10),
        axis.title.y=element_text(size=12),
        axis.title.x=element_text(size=12))
ggsave(here::here("output_selected_model","prior_checks","prior_checks_student","ICC_density_student_1.png"), height=4, width=6)
