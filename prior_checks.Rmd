...
r2.df<-data.frame(type=c(rep("marginal", 8000), rep("conditional", 8000)),
                  r2=c(post_student$r2_marginal, post_student$r2_conditional))
...
ggsave(here::here("output_selected_model","prior_checks","prior_checks_student","R2_density_student_10.png"), height=4, width=6)
