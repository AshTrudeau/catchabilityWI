...
write.csv(lakeChar, here::here("data","all.lake.char.csv"))
...
# creel_int4<-get_creel_int_party(wbic=wbics[301:350])
# 
...
write.csv(creel_harv_year, here::here("data","dnr.all.fish.annual.cpue.csv"))
