...
sigma_e<-post_gen$log_resid_sd
sigma_fixed<-post_gen$sigma_fixed
sigma_total<-post_gen$sigma_total
...
ggsave(here("output_selected_model","figures","beta.sigma.posterior.png"), height=8, width=6)
```
ICC
```{r}
...
ggsave(here::here("output_selected_model","figures","ICC_density.png"), height=4, width=6)
...
ggplot(r2.df)+
  ...
  theme_bw()+
    theme(legend.text=element_text(size=10),
        axis.title.y=element_text(size=12),
        axis.title.x=element_text(size=12))
ggsave(here::here("output_selected_model","figures","R2_density.png"), height=4, width=6)
