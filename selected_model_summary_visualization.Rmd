...
sigma.pred.df<-data.frame(param=c(rep("Full model", 8000), rep("Angler and date effects", 8000), 
  ...
  mutate(param=factor(param, levels=c("Angler and date effects","Population density effect","Full model")))
...
ggsave(here::here("output_selected_model","figures","submodel.sigma.density.png"), height=6, width=8)
```
