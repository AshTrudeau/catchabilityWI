...
ggplot(prop.var)+
  geom_density(aes(x=prop_var, fill=param))+
    scale_fill_manual(values=futurama[c(3,1,4,8)])+
    facet_wrap(.~param, ncol=1)+
  theme_classic()
...
```
```{r}
plot_grid(plot_grid(bar.plot, NULL, ncol=1, rel_heights=c(0.75, 0.25)), sigma.2.density, ncol=2, rel_widths=c(0.4, 0.6), labels=c("A","B"))
