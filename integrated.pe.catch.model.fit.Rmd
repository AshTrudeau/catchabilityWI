...
```{r}
print(real_fit, pars=c("log_q_mu","beta","phi", "log_mu_q_a", "sigma_q_a", "log_mu_q_d", "sigma_q_d", "log_mu_q_l", "sigma_q_l", "popDensity"), probs=c(.025,.5,.975))
...
```
Yeah, output is about the same. Slightly different shape on log_q_l distributions
